...
import com.appirio.service.member.events.MemberDeactivationEventHandler;
 ...
 */
public class MemberDeactivationEventHandlerTest {
    ...
    @Test
    public void testMemberDeactivationEventHandler() throws InvocationTargetException, NoSuchMethodException,
            InstantiationException, SupplyException, IllegalAccessException {
        MemberDeactivationEventHandler memberDeactivationEventHandler = new MemberDeactivationEventHandler(memberProfileDAO, eventProducer);
        memberDeactivationEventHandler.handleEvent(event);
